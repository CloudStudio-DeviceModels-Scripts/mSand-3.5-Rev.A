...
# Configuration Script – mSand - 3.5 - Rev. A

This **Configuration** script is designed for the **mSand - 3.5** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – mSand - 3.5 Rev. A

Este script de **Configuration** está diseñado para el modelo **mSand - 3.5** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
